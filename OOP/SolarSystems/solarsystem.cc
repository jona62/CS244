...
//sets the SolarSystem name
void SolarSystem::set_planet_id(string planet_id){
  this->planet_id = planet_id;
}

//sets the number of moons
void SolarSystem::set_num_of_moons(int num_of_moons){
  this->num_of_moons = num_of_moons;
}

//sets the names of the moons
void SolarSystem::set_moons(string moons){
  this->moons = moons;
}

//sets the radius of the SolarSystem
void SolarSystem::set_radius(double radius){
  this->radius = radius;
}

//sets the gravity of the planet
void SolarSystem::set_gravity_on_equator(double gravity_on_equator){
  this->gravity_on_equator = gravity_on_equator;
}

//sets the distance of the planet from the sun
void SolarSystem::set_distance_to_sun(double distance_to_sun){
  this->distance_to_sun = distance_to_sun;
}

//returns the number of moons the planet has
string SolarSystem::get_moons(){
  return(moons == "")?("None"):moons;
}

//returns the name of the planet
string SolarSystem::get_planet_id(){
  return planet_id;
}

//returns the number of moons a planet has
int SolarSystem::get_num_of_moons(){
  return num_of_moons;
}

//returns the radius of a planet
double SolarSystem::get_radius(){
  return radius;
}

//returns the distance of the planet from the sun
double SolarSystem::get_distance_to_sun(){
  return distance_to_sun;
}

//returns the gravity of the planet
double SolarSystem::get_gravity_on_equator(){
